...
COMMANDS: tuple = (
    ...
    CommandMeta("continue", "resume after max_rounds, an interruption, or a paused until-run",
    ...
    CommandMeta("memory", "show learnings, or: mine [n] to extract from sessions",
                accepts_arg=True, arg_hint="[query | mine [n]]", cli=True),
