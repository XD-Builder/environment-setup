...
COMMANDS: tuple = (
    ...
    CommandMeta("restore", "inject checkpoint or prior session transcript",
                accepts_arg=True, arg_hint="checkpoint|session <query> [fresh]"),
    ...
    CommandMeta("compact", "summarize thread for context recovery",
    ...
    CommandMeta("retro", "extract learnings from this session",
                cli=True, reserve_skill=False),
